...
ADD COLUMN     "bio" TEXT,
ADD COLUMN     "password" TEXT NOT NULL DEFAULT 'omar1234',
...
CREATE TABLE "_Contributors" (
    ...
    CONSTRAINT "_Contributors_AB_pkey" PRIMARY KEY ("A","B")
);
...
-- AddForeignKey
ALTER TABLE "PostVersion" ADD CONSTRAINT "PostVersion_editorId_fkey" FOREIGN KEY ("editorId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "_Contributors" ADD CONSTRAINT "_Contributors_A_fkey" FOREIGN KEY ("A") REFERENCES "Post"("id") ON DELETE CASCADE ON UPDATE CASCADE;
